          ...
          <div className="flex gap-4 items-center justify-between w-[100%]">
            <div>
              ...
              <div className="timer font-medium">
                ...
                :
                <span>
                  {String(Math.floor((todo.time / (1000 * 60)) % 60)).padStart(
                    2,
                    "0"
                  )}
                </span>
                :
                <span>
                  {String(Math.floor((todo.time / 1000) % 60)).padStart(2, "0")}
                </span>
              </div>
            </div>
