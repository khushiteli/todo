    ...
    <div className="w-[80vw] px-9 py-5 relative">
      ...
      <ul className="flex flex-col gap-5 list-container w-[100%]">
        {todos
            ...
            .map((todo) => <ListItem todo={todo} toggleTimer={toggleTimer} EditHandler={EditHandler} DeleteHandler={DeleteHandler}/> )
        }
        {todos
        ...
        {/* {todos.map((todo) => {
          return (<ListItem todo={todo} toggleTimer={toggleTimer} EditHandler={EditHandler} DeleteHandler={DeleteHandler}/>);
        })} */}
      </ul>
      <Link to="/todo">
        <button
